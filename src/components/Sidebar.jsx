...
export default function Sidebar() {
  return (
    <>
      <div className="col-span-1 w-28 min-h-full z-20 lg:flex py-6 justify-center fixed top-0 text-green-700  shadow-lg hidden">
        <ul className="flex flex-col justify-around">
          ...
          <NavLink to="/components">
            <li className="flex flex-col items-center transition-all">
              ...
              <p className="text-[0.8rem]">Components</p>
            </li>
          </NavLink>
        </ul>
      </div>
